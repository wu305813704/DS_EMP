package com.sunyard.emp.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.sunyard.emp.codegen.entity.ColumnEntity;
import com.sunyard.emp.codegen.entity.GenConfig;
import com.sunyard.emp.codegen.entity.TableEntity;
import com.sunyard.emp.codegen.exception.CheckedException;
...
public class GenUtils {
			...
			try {
				...
				zip.putNextEntry(new ZipEntry(Objects
					.requireNonNull(getFileName(template, tableEntity.getCaseClassName()
						, map.get("package").toString(), (String) map.get("moduleName")))));
	...
	private static String getFileName(String template, String className, String packageName, String moduleName) {
		moduleName =StringUtils.isBlank(moduleName) ? "" : moduleName+File.separator ;
		...
		if (template.contains(INDEX_VUE_VM)) {
			return CommonConstant.FRONT_END_PROJECT + File.separator + "src" + File.separator + "views" +
				File.separator + moduleName  + className.toLowerCase() + File.separator + "index.vue";
		}
